...
from id_funciones import leer_csv
from id_configuracion import (PIX_X,PIX_Y, dir_data, dir_hist,
                    ...
                    if validador:
                        ...
                        if validador:
                            ...
                            print('Lectura Incorrecta. Falla la validación del'
                                  'total del AFP') ####Cambiar los msges
                    else:
                        print('Lectura Incorrecta. Falla la validación de la'
                              'cuenta AFP') 
                else:
                    print('Lectura Incorrecta. Falla la validación del total'
                          'del APV')
            else:
                print('Lectura Incorrecta. Falla la validación de la cuenta'
                      'APV') 
        else:
            print('Lectura Incorrecta. Falla la validación del APV 15') 
        return validador
