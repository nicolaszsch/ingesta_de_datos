...
from id_valores import Valores
from id_registro import Registro
from id_interaccion_usuario import solicitar_fecha
...
def asingar_fecha():
    ...
    m , d = solicitar_fecha()
    id_configuracion.mes = m
    id_configuracion.dia = d
